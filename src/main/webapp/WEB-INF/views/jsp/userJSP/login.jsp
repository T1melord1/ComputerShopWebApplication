...
<c:if test="${not empty correctChangingPassword}">
    <div class="alert-success" style="color: green">${correctChangingPassword}</div>
</c:if>

<c:if test="${not empty errorChangingPassword}">
    <div class="alert" style="color: red">${errorChangingPassword}</div>
</c:if>
